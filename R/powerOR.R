...
#' @author Tanya Flynn
#'
#' @param caseN The number of cases
#' @param controlN The number of controls
#' @param controlA1 The allele frequency in controls
#' @param oddratio The odds ratio
#' @param siglevel The P value required to be significant

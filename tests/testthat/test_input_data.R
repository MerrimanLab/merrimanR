...
f <- data.frame(V1 = c(3,5,1), V1 = c("C8","A6","A2"), V3 = c(0,0,0), V4 = c(0,0,0), V5 = c(0,0,0), V6 = c(-9,-9,-9))
...
test_that("check correct input data structure",{
  ...
  expect_error(update_fam(fam = f, pheno_df = p, iid_col = "IID", pheno_col = "trait"), "Ensure column names of fam are 'FID','IID', 'PID','MID','SEX','AFF'")
})
